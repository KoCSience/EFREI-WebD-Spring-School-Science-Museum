...
<template>
  ...
  <div class="container">
    <div class="content">
      <img src="../assets/Transportation_Area.png" alt="交通エリア" />
    ...
    <div class="content">
      <img src="../assets/Home_Interior_Area.png" alt="インテリア（配線・電化製品）" />
    ...
    <div class="content">
      <img src="../assets/Stores_and_Restaurants_Area.png" alt="店舗とレストラン" />
    ...
    <div class="content">
      <img src="../assets/Souvenirs_Area.png" alt="お土産" />
      <p>Souvenirs Area</p>
      <details>
        <summary class="detail-button"></summary>
        <div>
    ...
    <div class="content">
      <img src="../assets/Factory_Area.png" alt="工場" />
      <p>Factory Area</p>
      <details>
        <summary class="detail-button"></summary>
        <div>
    ...
    <div class="content">
      <img src="../assets/Museum_Smartphone_Area.png" alt="ミュージアムスマートフォン" />
    ...
    <div class="content">
      <img src="../assets/Medical_Area.png" alt="医療エリア" />
      <p>Medical Area</p>
      <details>
        <summary class="detail-button"></summary>
        <div>
    ...
    <div class="content">
      <img src="../assets/WC_Area.png" alt="トイレ" />
      <p>WC Area</p>
      <details>
        <summary class="detail-button"></summary>
        <div>
    ...
    <div class="content">
      <img src="../assets/Wheel_Area.png" alt="観覧車" />
      <p>Ferris Wheel</p>
      <details>
        <summary class="detail-button"></summary>
        <div>
    ...
    <div class="content">
      <img src="../assets/Game_Area.png" alt="ゲームコーナー" />
      <p>Game Area</p>
      <details>
        <summary class="detail-button"></summary>
        <div>
